rootApp
.directive('libraryDetailPage', function() {
	return {
		restrict: 'E',
		templateUrl: './pages/libraryDetail/libraryDetail.html'
	};
})
.controller('libraryDetailPageController', function($scope, $timeout, API) {
	$scope.isShow = false;
	...
	$scope.$on('showLibraryDetailPage', function (event, args) {
		$scope.isShow = true;
		$timeout( function(){
		...
		$scope.isText = false;
		$scope.isPDF = false;
		$scope.form.title = $scope.stringEmpty;
		$scope.form.date = $scope.stringEmpty;
		$scope.form.message = $scope.stringEmpty;
		$scope.form.url = $scope.stringEmpty;
		$scope.form.fileType = $scope.stringEmpty;
